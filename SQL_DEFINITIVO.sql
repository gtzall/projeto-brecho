...
-- 1. GARANTIR QUE TABELAS EXISTEM COM TODAS AS COLUNAS

-- Categorias (primeiro, pois é referenciada)
...
-- 2. ADICIONAR COLUNA STATUS SE FALTAR (para tabelas antigas)
DO $$
BEGIN
